...
Go to your [GitHub account](https://github.com), click on the Plus icon (see [GitHub main window](#fig-github)) and create a New Repository (1).
...
The first figure is here:
[GitHub main window](#fig-settings).



[link to Figure A](#fig-A)
